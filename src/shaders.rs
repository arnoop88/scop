...
pub fn compile_shader(src: &str, shader_type: gl::types::GLenum) -> Result<gl::types::GLuint, String> {
...
pub fn link_program(vertex_shader: gl::types::GLuint, fragment_shader: gl::types::GLuint) -> Result<gl::types::GLuint, String> {
